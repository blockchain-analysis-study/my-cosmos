...
```bash
go test -v --bench my-cosmos/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: my-cosmos/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	my-cosmos/cosmos-sdk/crypto/keys/mintkey	12.093s
```
