...
import (
	...
	authsim "my-cosmos/cosmos-sdk/x/auth/simulation"
	"my-cosmos/cosmos-sdk/x/bank"
	banksim "my-cosmos/cosmos-sdk/x/bank/simulation"
	distr "my-cosmos/cosmos-sdk/x/distribution"
	distrsim "my-cosmos/cosmos-sdk/x/distribution/simulation"
	"my-cosmos/cosmos-sdk/x/gov"
	govsim "my-cosmos/cosmos-sdk/x/gov/simulation"
	"my-cosmos/cosmos-sdk/x/mint"
	"my-cosmos/cosmos-sdk/x/mock/simulation"
	"my-cosmos/cosmos-sdk/x/slashing"
	slashingsim "my-cosmos/cosmos-sdk/x/slashing/simulation"
	"my-cosmos/cosmos-sdk/x/staking"
	stakingsim "my-cosmos/cosmos-sdk/x/staking/simulation"
)
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ my-cosmos/cosmos-sdk/cmd/gaia/app -bench ^BenchmarkFullGaiaSimulation$ -SimulationCommit=true -cpuprofile cpu.out
