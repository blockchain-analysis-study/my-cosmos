...
::: tip 
See the [launch repo](https://my-cosmos/launch) for
...
Note we use the `latest` directory in the [launch repo](https://my-cosmos/launch) which contains details for the mainnet like the latest version and the genesis file. 
...
Your node needs to know how to find peers. You'll need to add healthy seed nodes to `$HOME/.gaiad/config/config.toml`. The [`launch`](https://my-cosmos/launch) repo contains links to some seed nodes.
