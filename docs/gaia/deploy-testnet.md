...
Supporting code can be found in the [networks directory](https://my-cosmos/cosmos-sdk/tree/develop/networks) and additionally the `local` or `remote` sub-directories.
...
From the [networks/local directory](https://my-cosmos/cosmos-sdk/tree/develop/networks/local):
...
The following should be run from the [networks directory](https://my-cosmos/cosmos-sdk/tree/develop/networks).
