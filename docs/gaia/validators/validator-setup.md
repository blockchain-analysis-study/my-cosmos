...
::: tip
Information on how to join the mainnet (`genesis.json` file and seeds) is held [in our `launch` repo](https://my-cosmos/launch/tree/master/latest). 
:::
...
You can then submit your `gentx` on the [launch repository](https://my-cosmos/launch). These `gentx` will be used to form the final genesis file. 
