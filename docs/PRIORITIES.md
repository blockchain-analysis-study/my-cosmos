...
- [Prelaunch Issues](https://my-cosmos/cosmos-sdk/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Astaking+label%3Aprelaunch-2.0)

## Multisig

- Need to test changes in https://my-cosmos/cosmos-sdk/pull/2165
- Spam prevention - https://my-cosmos/cosmos-sdk/issues/2019
...
- LCD
- Each module
- Tags [#1780](https://my-cosmos/cosmos-sdk/issues/1780)
# Lower priority
...
- Circuit breaker - https://my-cosmos/cosmos-sdk/issues/926
- Parameter change proposals (roughly the same implementation as circuit breaker)

## Staking / Slashing - Stability

- Consider "tombstone" / "prison" - double-sign and you can never validate again - https://my-cosmos/cosmos-sdk/issues/2363
