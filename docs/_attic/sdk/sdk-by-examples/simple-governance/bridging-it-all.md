...
*Note: You can check the full file (with comments!) [here](https://my-cosmos/cosmos-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/app/app.go)*
...
**File: [`cmd/simplegovcli/maing.go`](https://my-cosmos/cosmos-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/cmd/simplegovcli/main.go)**
...
**File: [`cmd/simplegovd/main.go`](https://my-cosmos/cosmos-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/cmd/simplegovd/main.go)**
...
**File: [`app/app.go`](https://my-cosmos/cosmos-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/app/app.go)**
