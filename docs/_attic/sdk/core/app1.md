...
See the [Context API
docs](https://godoc.org/my-cosmos/cosmos-sdk/types#Context) for more details.
...
Coins](https://godoc.org/my-cosmos/cosmos-sdk/types#Coins).
...
See the [BaseApp API
documentation](https://godoc.org/my-cosmos/cosmos-sdk/baseapp) for more details.
