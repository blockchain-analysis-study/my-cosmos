...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://my-cosmos/cosmos-sdk/tree/master/CONTRIBUTING.md)
...
[master](https://my-cosmos/cosmos-sdk/tree/master/docs)
and [develop](https://my-cosmos/cosmos-sdk/tree/develop/docs),
respectively.
...
Then, edit the `swagger.yaml` manually; it is found [here](https://my-cosmos/cosmos-sdk/blob/develop/client/lcd/swagger-ui/swagger.yaml)
