...
- `into`: Introductory material. Goal is to have a short explainer of the SDK and then channel people to the resource they need. The [sdk-tutorial](https://my-cosmos/sdk-application-tutorial/) will be highlighted, as well as the `godocs`.
...
- Will help build an executable doc (cf https://my-cosmos/cosmos-sdk/issues/2611)
...
- https://my-cosmos/cosmos-sdk/issues/1460
- https://my-cosmos/cosmos-sdk/pull/2695
- https://my-cosmos/cosmos-sdk/issues/2611
